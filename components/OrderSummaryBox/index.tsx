...
const classesOrderSummary = {
  ...
  voucherDetailPopUpBodyClassName: styles.ordersummary_voucherDetailPopUpBody,
  voucherDetailPopUpHeaderClassName: styles.ordersummary_voucherDetailPopUpHeader,
  voucherDetailPopUpHeaderTitleClassName: styles.ordersummary_voucherDetailPopUpHeaderTitle,
  voucherDetailPopUpCloseClassName: styles.ordersummary_voucherDetailPopUpClose,
  voucherDetailPopUpDescContainerClassName: styles.ordersummary_voucherDetailPopUpDescContainer,
  voucherDetailPopUpDescDateClassName: styles.ordersummary_voucherDetailPopUpDescDate,
  voucherDetailPopUpCodeContainerClassName: styles.ordersummary_voucherDetailPopUpCodeContainer,
  voucherDetailPopUpCodeTitleClassName: styles.ordersummary_voucherDetailPopUpCodeTitle,
  voucherDetailPopUpCodeCopyContainerClassName: styles.ordersummary_voucherDetailPopUpCodeCopyContainer,
  voucherDetailPopUpCodeCopyTitleClassName: styles.ordersummary_voucherDetailPopUpCodeCopyTitle,
  voucherDetailPopUpCodeCopyButtonClassName: styles.ordersummary_voucherDetailPopUpCodeCopyButton,
  voucherDetailPopUpUseCouponClassName: styles.ordersummary_voucherDetailPopUpUseCoupon,
